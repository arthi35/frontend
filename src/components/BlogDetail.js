...
const[blog,setBlog]=useState()
  ...
  const fetchDetails=async()=>{
    const res=await axios.get(`https://blogapplication001.herokuapp.com/api/blog/${id}`).catch(err=>console.log(err))
    const data=res.data;
    return data;
  }
...
const res=await axios.put(`https://blogapplication001.herokuapp.com/api/blog/update/${id}`,{
title:inputs.title,
